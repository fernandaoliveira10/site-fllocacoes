...
const productIncludes: Record<string, string[]> = {
  PLATAFORMA_360: [
    ...
    "Iluminacao LED",
    "Videos disponiveis automaticamente via QR Code",
    "Moldura personalizada e musica escolhida pelo cliente",
  ],
  CAMA_ELASTICA: ["Montagem", "Desmontagem", "Equipamento higienizado", "Monitor (opcional)"],
  FOTOGRAFIA: [
    "Cobertura durante todo o periodo contratado",
...
<section id="banner" className="py-12 sm:py-14 lg:py-16">
...
<section className="py-16">
  <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
    <div className="grid place-items-center">
      <div className="relative w-full overflow-hidden rounded-[2rem] border border-fl-gray-200 bg-white p-8 shadow-soft lg:p-12">
        ...
        <div className="relative mx-auto max-w-4xl text-center">
          ...
          <h2 className="mt-3 font-display text-3xl font-bold tracking-tight text-fl-blue-dark sm:text-4xl lg:text-5xl">
          ...
          <div className="mx-auto mt-8 grid max-w-3xl gap-4 sm:grid-cols-3">
            <div className="rounded-2xl border border-fl-gray-200 bg-fl-gray-50 px-5 py-4 text-center">
              <p className="text-sm font-semibold text-fl-blue-dark">Plataforma 360°</p>
              <p className="mt-1 text-sm text-fl-gray-500">Conteúdo moderno e divertido</p>
            </div>

            <div className="rounded-2xl border border-fl-gray-200 bg-fl-gray-50 px-5 py-4 text-center">
              <p className="text-sm font-semibold text-fl-blue-dark">Cama elástica</p>
              <p className="mt-1 text-sm text-fl-gray-500">Mais energia para a festa</p>
            </div>

            <div className="rounded-2xl border border-fl-gray-200 bg-fl-gray-50 px-5 py-4 text-center">
              <p className="text-sm font-semibold text-fl-blue-dark">Foto profissional</p>
              <p className="mt-1 text-sm text-fl-gray-500">Memórias com qualidade</p>
            </div>
          </div>
      ...
      <section id="produtos" className="py-20">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <p className="text-center text-xs font-semibold uppercase tracking-[0.2em] text-fl-blue">Tabela de precos</p>
          ...
          <p className="mx-auto mt-4 max-w-2xl text-center text-base leading-7 text-fl-gray-600">
            Veja os valores fixos, deixe o deslocamento sob consulta e monte seu orcamento com rapidez.
          </p>
          ...
          <div className="mt-16 space-y-20">
            {mainProducts.map((product) => {
              ...
              return (
                <div key={product.id} className="grid gap-8 lg:grid-cols-[minmax(0,0.92fr)_minmax(0,1.08fr)] lg:items-center">
                  <ImageCarousel
                    images={slides}
                    mediaFit="contain"
...
<section
  id="contato"
  className="mt-20 overflow-hidden rounded-3xl border border-fl-gray-200 bg-fl-gray-50 p-6 shadow-soft lg:p-8"
>
